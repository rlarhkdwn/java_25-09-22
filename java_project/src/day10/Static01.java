...
class Tv{
	...
	public void printBrand1() {
		// 객체 메서드에서 static변수나, 객체 변수는 사용 가능
		System.out.println("Brand: " + BRAND);
		System.out.println(power);
	}
	
	public static void printBrand2() { // 생성된 시점에 power 변수는 생성되지 않을 수 있음
		System.out.println("Brand: " + BRAND);
		// System.out.println(power); // 호출 불가
	}
}